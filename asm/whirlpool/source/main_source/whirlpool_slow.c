...
путём циклического сдвига её трёх последних столбцов на различные смещения
*/
static
...
static
void whirlpool_hash_slow(uint64_t s[8], const unsigned char buffer[64]) {
...
/*-------------------------------------------------------------------------- */
static void uint32_to_bytes(unsigned char *out, const uint32_t *in) {
...
/*-------------------------------------------------------------------------- */
void whirlpool_final_slow(struct context_slow *ctx, unsigned char digest[64]) {
