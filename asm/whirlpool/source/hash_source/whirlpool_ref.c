...
/*
Заранее вычисленные таблицы W0..W3 используются для реализации процедуры mix_rows.
*/
const uint64_t W0[] = {
...
static
void whirlpool_hash_ref(uint64_t s[8], const unsigned char buffer[64]) {
...
/*-------------------------------------------------------------------------- */
void whirlpool_final_ref(struct context_ref *ctx, unsigned char digest[64]) {
